...
/// The discussion URL of the class, containing bugfixes necassary for the code to work:
/// http://irrlicht.sourceforge.net/forum/viewtopic.php?f=9&t=21657&hilit=input+handling
/// ==================================================================================================
